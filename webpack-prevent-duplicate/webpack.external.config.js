...
module.exports = {
    ...
    //todo el codigo comun lo enviara al archivo commons como standard

    optimization: {
        splitChunks: {
            chunks: 'all',
            minSize: 0, // X ejemplo si es un arhcivo muy pequeño y se esta duplicando no hace falta que lo ponga en el common(
                //0= todo el codigo duplicado vaya al common)
            name: 'commons'
        }
    }
}
